package com.github.hooj0.chaincode.core.configuration;
 ...
 */
@Configuration
@ComponentScan(basePackages = "com.github.hooj0.chaincode.**")
@EnableChaincodeRepositories(basePackages = "com.github.hooj0.chaincode.**.repository", considerNestedRepositories = true)
