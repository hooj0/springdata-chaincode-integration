...
function up() {
	...
	# start
	log purple "===> docker-compose -f docker-compose.yaml -f docker-compose-host.yaml up"
	docker-compose -f docker-compose.yaml -f docker-compose-host.yaml up
}

function start() {	
	# start
	log purple "===> docker-compose -f docker-compose.yaml -f docker-compose-host.yaml start"
	docker-compose -f docker-compose.yaml -f docker-compose-host.yaml start
}

function stop() {	
	# start
	log purple "===> docker-compose -f docker-compose.yaml -f docker-compose-host.yaml stop"
	docker-compose -f docker-compose.yaml -f docker-compose-host.yaml stop
}
